...
public class QueryQueriesErregistratua extends JFrame {
	...
	private final JButton atzeraButton = new JButton("<--"); //$NON-NLS-1$ //$NON-NLS-2$

	private String log;
	public QueryQueriesErregistratua(String log)
	{
		try
		{
			this.log=log;
	...
	{
		setTitle("QUERY QUESTIONS");
		this.getContentPane().setLayout(null);
		this.setSize(new Dimension(700, 500));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("QueryQueries"));

		jLabelEventDate.setBounds(new Rectangle(83, 20, 140, 25));
		jLabelQueries.setBounds(138, 226, 406, 14);
		jLabelEvents.setBounds(295, 24, 259, 16);
...
//					jCalendar1.setCalendar(calendarAct);
		...
		scrollPaneQueries.setBounds(new Rectangle(138, 250, 406, 116));
		...
		atzeraButton.setFont(new Font("Tahoma", Font.PLAIN, 16));
		atzeraButton.setBounds(10, 10, 63, 21);
		...
		euskeraRdioButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				nirePantaila.setTitle(ResourceBundle.getBundle("Etiquetas").getString("QueryQueries"));
